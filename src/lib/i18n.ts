...
export const translations = {
  en: {
    ...
    anyDeskUser: 'AnyDesk User',
    passwordAnydesk: 'AnyDesk Password',
    ...
    assistantSubtitle: 'Arabic & English help',
    assistantPlaceholder: 'Ask anything about the system...',
    ...
    byDepartmentReport: 'Assets by Department',
    byBranchReport: 'Assets by Branch',
    byStatusReport: 'Assets by Status',
    byCategoryReport: 'Assets by Category',
    byManufacturerReport: 'Assets by Manufacturer',
    byAssigneeReport: 'Assets by Assignee',
    unassignedReport: 'Unassigned Assets',
    departmentsReport: 'Departments Summary',
    branchesReport: 'Branches Summary',
    personsReport: 'Persons / Assignees',
    maintenanceReport: 'Maintenance & Repair',
    importsReport: 'Import History',
  ...
  ar: {
    ...
    partNo: 'رقم القطعة',
    employeePosition: 'المسمى الوظيفي',
    employeeCode: 'رقم الموظف',
    startupDate: 'تاريخ التشغيل',
    site: 'الموقع',
    vendorName: 'اسم المورد',
    anyDeskUser: 'مستخدم AnyDesk',
    passwordAnydesk: 'كلمة مرور AnyDesk',
    userAdmin: 'مستخدم Admin',
    passwordAdmin: 'كلمة مرور Admin',
    ipAddress: 'عنوان IP',
    ...
    assistantSubtitle: 'مساعدة بالعربية والإنجليزية',
    assistantPlaceholder: 'اسأل عن أي جزء من النظام...',
    ...
    byDepartmentReport: 'الأصول حسب القسم',
    byBranchReport: 'الأصول حسب الفرع',
    byStatusReport: 'الأصول حسب الحالة',
    byCategoryReport: 'الأصول حسب الفئة',
    byManufacturerReport: 'الأصول حسب الشركة المصنعة',
    byAssigneeReport: 'الأصول حسب المسؤول',
    unassignedReport: 'الأصول غير المعينة',
    departmentsReport: 'ملخص الأقسام',
    branchesReport: 'ملخص الفروع',
    personsReport: 'الأشخاص / المسؤولين',
    maintenanceReport: 'الصيانة والإصلاح',
    importsReport: 'سجل الاستيراد',
    assetReports: 'تقارير الأصول',
    organizationReports: 'تقارير التنظيم',
